...
class TestCliAuthCommands:
    ...
    @patch.dict(os.environ, {"AIRFLOW_CLI_TOKEN": "TEST_TOKEN"})
    @patch("airflowctl.api.client.keyring")
    def test_login_with_api_token_no_keyring(self, mock_keyring, api_client_maker):
    ...
    @patch("airflowctl.api.client.keyring")
    def test_login_with_api_token_no_keyring_fails(self, mock_keyring, api_client_maker):
        from keyring.errors import NoKeyringError
